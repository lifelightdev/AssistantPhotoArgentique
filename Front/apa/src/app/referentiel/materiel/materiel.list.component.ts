...
export class MaterielListComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.materielService.rechercheTousLesModeles().subscribe(data => {
      this.modeles = data;
    });
    this.materielService.rechercheTousLesTypesDeMateriel().subscribe(data => {
      this.types = data;
    });
    this.materielService.rechercheTousLesSousType().subscribe(data => {
      this.sousTypes = data;
    });
    this.materielService.rechercheTousLesStatutsDeMateriel().subscribe(data => {
      this.statuts = data;
    });
  }
  ...
  onSubmit() {
    this.submitted = true;
    this.materielService.recherchedesMateriels(this.modelRecherche).subscribe(data => {
      this.dataSource.data = data;
    });
  }
